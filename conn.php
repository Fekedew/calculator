<?php
	...
	// $query2="DROP TABLE `history`";	
	$query2="CREATE TABLE IF NOT EXISTS `history`(his_id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, expression TEXT, result TEXT )";	
	$conn->exec($query);
	$conn->exec($query2);
?>